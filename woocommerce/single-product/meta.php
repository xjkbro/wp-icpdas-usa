...
<div class="product_meta">
    ...
    <div class="single_product_references border-solid border-2 border-primary rounded-lg shadow-lg bg-primary text-white">
        <div class="font-bold text-lg">Product References</div>
        <?php foreach($additionalReferences as $ref) {
            $file = get_field($ref);
            
            if ($file) : ?>
                <div><a href="<?=$file['url']?>"><?=$ref?></a></div>
            <?php endif; ?>
